...
public class TodoListServiceChapter6Impl implements TodoListService {
	...
	static{
		todoList.add(new Todo(todoId++,"Element1",Priority.LOW,null,null));
		todoList.add(new Todo(todoId++,"Element2",Priority.MEDIUM,dayAfter(10),null));
		todoList.add(new Todo(todoId++,"Element3",Priority.HIGH,dayAfter(5),"Description3"));
	}
