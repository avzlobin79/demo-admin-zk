...
public class SidebarPageConfigAjaxBasedImpl implements SidebarPageConfig{
	...
	//	pageMap.put("devref",new SidebarPage("devref","ZK Developer Reference","/imgs/doc.png","http://books.zkoss.org/wiki/ZK_Developer's_Reference"));
		...
		pageMap.put("fn3",new SidebarPage("fn3","Example CRUD","/imgs/fn.png","/chapter6/todolist-mvc.zul"));
		//pageMap.put("fn4",new SidebarPage("fn4","Todo List ()","/imgs/fn.png","/chapter6/todolist-mvvm.zul"));
		pageMap.put("Google Map",new SidebarPage("gm","Google Map","/imgs/fn.png","/gm/google_map_ctrl.zul"));
	}
